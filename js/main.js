...
$(function () {
  ...
  $("#menu-select-event").on("click", function () {
    ...
    $(".mil-has-children ul").removeClass("mil-active");
    $(".mil-has-children a").removeClass("mil-active");
    $(".mil-has-children a").toggleClass("mil-active");
    $(".mil-has-children a").next().toggleClass("mil-active");
  });
  /***************************
      ...
      slideChange: function () {
        ...
        $(".rel-heart")
          .removeClass(function (i, c) {
            // mevcut g-* classlarını temizle
            return (c.match(/(^|\s)g-\d+/g) || []).join(" ");
          })
          .addClass("g-" + newIndex);
        $("#g-heart").html(hearts[this.activeIndex]);
      },
    },
  });
  ...
  document.addEventListener("swup:contentReplaced", function () {
    ...
    /***************************
        ...
        ***************************/
    $(".mil-menu-btn").removeClass("mil-active"); // HERE 1
